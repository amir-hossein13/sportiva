...
function ContorolBar() {
    return (
      <div className="mt-7 flex gap-3">
        ...
        <button className="admin-button-cart-mini border-aqua text-aqua border hover:bg-[#005b6a]">
          فیلتر <HiOutlineFunnel />
        </button>
      </div>
    );
}

export default ContorolBar
